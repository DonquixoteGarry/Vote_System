...
> 神经元结构参考网址:
>
> [初识神经网络中的各种层和神经网络结构_ch206265的博客-CSDN博客_神经网络的各个层](https://blog.csdn.net/ch206265/article/details/106962756)
>
> [深入学习卷积神经网络中卷积层和池化层的意义 - 战争热诚 - 博客园 (cnblogs.com)](https://www.cnblogs.com/wj-1314/p/9593364.html)
...
- 卷积层: 一种多输入和多结果的运算,但是结果个数与输入个数

  - 每个结果的与每个输入的不同的某个特定局部相关(局部感知)
...
class Net(nn.Module):
    ...
    def __init__(self):
        ...
        # an affine operation(仿射变换): y = Wx + b
